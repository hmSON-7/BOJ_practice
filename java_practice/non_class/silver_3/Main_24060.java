...
public class Main_24060 {
	...
	/* 
	 * BOJ_24060 : 알고리즘 수업 - 병합 정렬 1(Silver_3)
	 * 자료구조 및 알고리즘 : 구현, 병합 정렬
	 * 서브 배열로 분리된 두 개의 배열 내 값을 비교한 뒤 작은 수부터 임시 배열에 담고, 실제 배열에 임시 배열의 값을 옮긴다.
	 * 이 때 수 하나가 옮겨지는 과정을 1회 저장으로 간주하고, K번째 저장을 해야 하는 시점에 어떤 수를 저장해야 하는 지 알아내야 한다.
	...
	static void mergeSort(int left, int right) {
		...
		// 또한 저장 과정에서 저장 횟수를 카운트하고, 만약 K번째 저장까지 도달한 경우 그 때 다루는 수(arr[i]) 출력 후 실행 종료
